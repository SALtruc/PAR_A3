...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('side_escape_angular_speed', default_value='0.38'),
        ...
        DeclareLaunchArgument('edge_escape_angular_speed', default_value='0.55'),
        ...
        DeclareLaunchArgument('dodge_forward_speed', default_value='0.060'),
        ...
        DeclareLaunchArgument('creep_speed', default_value='0.055'),
