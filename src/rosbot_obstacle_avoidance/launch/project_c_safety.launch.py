...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('pointcloud_low_min_points', default_value='8'),
        ...
        DeclareLaunchArgument('low_obstacle_backup_distance', default_value='0.28'),
        ...
        DeclareLaunchArgument('front_tof_hard_distance', default_value='0.18'),
        ...
        DeclareLaunchArgument('corner_backup_sec', default_value='1.00'),
        ...
        DeclareLaunchArgument('rotation_angular_speed', default_value='0.45'),
        ...
        DeclareLaunchArgument('dynamic_observe_distance', default_value='1.20'),
        DeclareLaunchArgument('dynamic_timeout_sec', default_value='1.0'),
    ...
    obstacle_perception = Node(
        ...
        parameters=[
            config,
            {
                ...
                'depth_motion_enabled': as_bool('depth_motion_enabled'),
                'depth_motion_delta_m': as_float('depth_motion_delta_m'),
                'depth_motion_near_m': as_float('depth_motion_near_m'),
                'depth_motion_min_ratio': as_float('depth_motion_min_ratio'),
                'depth_motion_confirm_frames': as_int('depth_motion_confirm_frames'),
