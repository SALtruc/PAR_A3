...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('dodge_angular_speed', default_value='0.35'),
        DeclareLaunchArgument('dodge_step_deg', default_value='55.0'),
        DeclareLaunchArgument('dodge_pivot_sec', default_value='0.70'),
