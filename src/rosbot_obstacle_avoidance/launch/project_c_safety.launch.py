...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('pointcloud_low_min_height_m', default_value='-0.25'),
        DeclareLaunchArgument('pointcloud_low_max_height_m', default_value='-0.05'),
        ...
        DeclareLaunchArgument('low_obstacle_min_points', default_value='20'),
