...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('pointcloud_use_tf', default_value='false'),
        ...
        DeclareLaunchArgument('pointcloud_low_min_height_m', default_value='-0.35'),
        DeclareLaunchArgument('pointcloud_low_max_height_m', default_value='0.15'),
        DeclareLaunchArgument('pointcloud_low_center_half_width_m', default_value='0.38'),
        ...
        DeclareLaunchArgument('tof_msg_type', default_value='scan'),
        DeclareLaunchArgument('rear_tof_topics', default_value='/range/rl,/range/rr'),
        ...
        DeclareLaunchArgument('max_speed', default_value='0.215'),
        DeclareLaunchArgument('emergency_distance', default_value='0.10'),
        DeclareLaunchArgument('perception_obstacle_distance', default_value='0.35'),
        ...
        DeclareLaunchArgument('low_obstacle_distance', default_value='0.45'),
        DeclareLaunchArgument('low_obstacle_backup_distance', default_value='0.20'),
        ...
        DeclareLaunchArgument('pre_dodge_backup_clear_bonus_sec', default_value='0.80'),
        DeclareLaunchArgument('low_obstacle_min_points', default_value='8'),
        DeclareLaunchArgument('low_obstacle_hold_sec', default_value='0.70'),
        ...
        DeclareLaunchArgument('side_escape_distance', default_value='0.03'),
        DeclareLaunchArgument('side_escape_release_distance', default_value='0.08'),
        ...
        DeclareLaunchArgument('side_escape_max_attempts', default_value='4'),
        ...
        DeclareLaunchArgument('edge_escape_angular_speed', default_value='0.30'),
        DeclareLaunchArgument('edge_escape_sec', default_value='0.80'),
        DeclareLaunchArgument('edge_escape_max_attempts', default_value='3'),
        DeclareLaunchArgument('corner_backup_side_distance', default_value='0.00'),
        DeclareLaunchArgument('corner_backup_front_distance', default_value='0.35'),
        DeclareLaunchArgument('corner_backup_both_sides_distance', default_value='0.00'),
        ...
        DeclareLaunchArgument('rotation_angular_speed', default_value='0.30'),
        ...
        DeclareLaunchArgument('creep_speed', default_value='0.030'),
        DeclareLaunchArgument('surprise_backup_enabled', default_value='false'),
        ...
        DeclareLaunchArgument('dynamic_observe_distance', default_value='1.00'),
        ...
        DeclareLaunchArgument('min_battery_voltage', default_value='8.5'),
        DeclareLaunchArgument('warn_battery_voltage', default_value='9.0'),
        ...
        DeclareLaunchArgument('contact_stall_sec', default_value='5.00'),
    ...
    obstacle_perception = Node(
        ...
        parameters=[
            config,
            {
                ...
                'rear_tof_topics': LaunchConfiguration('rear_tof_topics'),
    ...
    obstacle_avoidance = Node(
        ...
        parameters=[
            config,
            {
                ...
                'low_obstacle_distance': as_float('low_obstacle_distance'),
                'low_obstacle_backup_distance': as_float(
                    'low_obstacle_backup_distance'
                ),
                'low_obstacle_min_points': as_int('low_obstacle_min_points'),
                'low_obstacle_hold_sec': as_float('low_obstacle_hold_sec'),
                'pre_dodge_backup_enabled': as_bool('pre_dodge_backup_enabled'),
                'pre_dodge_backup_sec': as_float('pre_dodge_backup_sec'),
                'pre_dodge_backup_clear_bonus_sec': as_float('pre_dodge_backup_clear_bonus_sec'),
                'front_tof_obstacle_distance': as_float('front_tof_obstacle_distance'),
                'front_tof_hard_distance': as_float('front_tof_hard_distance'),
                ...
                'side_escape_release_distance': as_float('side_escape_release_distance'),
                'side_escape_forward_speed': as_float('side_escape_forward_speed'),
                'side_escape_angular_speed': as_float('side_escape_angular_speed'),
                'side_escape_counter_scale': as_float('side_escape_counter_scale'),
                'side_escape_sec': as_float('side_escape_sec'),
                'side_escape_max_attempts': as_int('side_escape_max_attempts'),
