...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('pointcloud_low_min_height_m', default_value='-0.45'),
        ...
        DeclareLaunchArgument('dodge_clearance', default_value='0.010'),
        DeclareLaunchArgument('rear_stop_distance', default_value='0.20'),
        DeclareLaunchArgument('side_guard_distance', default_value='0.010'),
        DeclareLaunchArgument('side_escape_distance', default_value='0.025'),
        ...
        DeclareLaunchArgument('backup_sec', default_value='1.20'),
