...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('pre_dodge_backup_enabled', default_value='false'),
        ...
        DeclareLaunchArgument('front_tof_obstacle_distance', default_value='0.25'),
        DeclareLaunchArgument('front_tof_hard_distance', default_value='0.12'),
        DeclareLaunchArgument('dodge_clearance', default_value='0.20'),
        ...
        DeclareLaunchArgument('edge_escape_clearance', default_value='0.45'),
        ...
        DeclareLaunchArgument('corner_backup_both_sides_distance', default_value='0.14'),
        ...
        DeclareLaunchArgument('observe_frames', default_value='3'),
        DeclareLaunchArgument('clear_observe_frames', default_value='2'),
        ...
        DeclareLaunchArgument('creep_speed', default_value='0.015'),
        ...
        DeclareLaunchArgument('dynamic_observe_distance', default_value='0.50'),
        DeclareLaunchArgument('dynamic_timeout_sec', default_value='0.8'),
    ...
    obstacle_avoidance = Node(
        ...
        parameters=[
            config,
            {
                ...
                'dynamic_timeout_sec': as_float('dynamic_timeout_sec'),
